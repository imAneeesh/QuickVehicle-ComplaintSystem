...
<head>
  <meta charset="UTF-8">
  <title>USER sign in / sign up form</title>
...
<br>
    <div class="cont">
        <div class="form sign-in">
            ...
            <button  name="signin" class="submit">Sign In</button>
</form>
        </div>
        <div class="sub-cont">
            <div class="img">
            ...
            <div class="form sign-up">
                ...
                <button  name="signup" class="submit">Sign Up</button>
